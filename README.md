...
* 0.0.1
    * 작업 진행 중
## 게임의 장점
이 게임의 장점으로는 실감 나면서도 안전한 체험에 있다 현실에선 불가능한 위험한 레일을 모션디바이스와 오큘러스 리프트의 장비효과를 살려 마음껏 즐길 수 있다.
여타 3D 체험관의 시뮬레이션들보다 사실감 넘치는 가상현실 체험과 상호작용이 가능하다.

## 추가 개발 및 개선 요구사항

완성된 트랙이 하나 뿐 이기에 여러 번 게임을 즐기기에 부족한 부분이 있다. 이를 개선하기 위하여 추가적으로 트랙과 맵을 제작해야 할 필요가 있다.
